 ...
 *
 * @googletest\googletest\include\gtest\gtest-param-test.h device [const char*] The interface
 * @googletest\googletest\include\gtest\gtest-param-test.h snaplen [const int] The upper bound of the bits for each packet
 * @googletest\googletest\include\gtest\gtest-param-test.h promisc [const int] Specifying that the device is to be put into promiscuous mode.
 * A value of 1 (True) turns promiscuous mode on.
 * @googletest\googletest\include\gtest\gtest-param-test.h timeout [const int] Timeout (milliseconds)
 * @googletest\googletest\include\gtest\gtest-param-test.h port [std::vector<int>*] The port of the server for distinguishing with the packets from rx and tx
 */
 ...
 *
 * @googletest\googletest\include\gtest\gtest-param-test.h callback [void (*)(u_char*, const pcap_pkthdr*, const u_char*)] The callback function for pcap_loop;
 ...
 *
 * @googletest\googletest\include\gtest\gtest-param-test.h userData [u_char*] The additional information for the function, packetHandler; the additional information will be binding with
 * the forth argument in the pcap_loop
 * @googletest\googletest\include\gtest\gtest-param-test.h pkthdr [const struct pcap_pkthdr*] The header of the packet
 * @googletest\googletest\include\gtest\gtest-param-test.h packet [const u_char*] The data from the last position of the header of the packet
 */
